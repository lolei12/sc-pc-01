  ...
  <div>
    ...
    <div class="header w1210 bc mt15">
      ...
      <div class="logo w1210">
        <h1 class="fl">
          <a href="index.html"><img src="/images/logo.png" alt="商城" /></a>
        </h1>
        <!-- 头部搜索 start -->
        <div class="search fl">
          <div class="search_form">
            ...
            <form action="" name="serarch" method="get" class="fl">
              <input type="text" class="txt" value="请输入商品关键字" /><input
                type="submit"
                class="btn"
                value="搜索"
              />
        ...
        <div class="user fl">
          <dl>
            ...
            <dd>
              <div class="prompt">您好，请<a href="">登录</a></div>
              ...
              <div class="viewlist mt10">
                ...
                <ul>
                  <li>
                    <a href=""><img src="/images/view_list1.jpg" alt="" /></a>
                  </li>
                  <li>
                    <a href=""><img src="/images/view_list2.jpg" alt="" /></a>
                  </li>
                  <li>
                    <a href=""><img src="/images/view_list3.jpg" alt="" /></a>
                  </li>
                </ul>
              </div>
            </dd>
      ...
      <div class="goods_left fl">
          ...
          <div class="leftbar_wrap">
            <ul>
              <li>
                <dl>
                  <dt>
                    <a href=""><img src="/images/relate_view1.jpg" alt="" /></a>
                  </dt>
                  <dd>
                    <a href=""
                      >ThinkPad E431(62771A7) 14英寸笔记本电脑 (i5-3230 4G 1TB
                      2G独显 蓝牙 win8)</a
                    >
                  </dd>
              ...
              <li>
                <dl>
                  <dt>
                    <a href=""><img src="/images/relate_view2.jpg" alt="" /></a>
                  </dt>
                  <dd>
                    <a href=""
                      >ThinkPad X230i(2306-3V9） 12.5英寸笔记本电脑 （i3-3120M
                      4GB 500GB 7200转 蓝牙 摄像头 Win8）</a
                    >
                  </dd>
                  <dd><strong>￥5199.00</strong></dd>
                </dl>
              ...
              <li>
                <dl>
                  <dt>
                    <a href=""><img src="/images/relate_view3.jpg" alt="" /></a>
                  </dt>
                  <dd>
                    <a href=""
                      >T联想（Lenovo） Yoga13 II-Pro 13.3英寸超极本 （i5-4200U
                      4G 128G固态硬盘 摄像头 蓝牙 Win8）晧月银</a
                    >
                  </dd>
              ...
              <li>
                <dl>
                  <dt>
                    <a href=""><img src="/images/relate_view4.jpg" alt="" /></a>
                  </dt>
                  <dd>
                    <a href=""
                      >联想（Lenovo） Y510p 15.6英寸笔记本电脑（i5-4200M 4G 1T
                      2G独显 摄像头 DVD刻录 Win8）黑色</a
                    >
                  </dd>
              ...
              <li class="last">
                <dl>
                  <dt>
                    <a href=""><img src="/images/relate_view5.jpg" alt="" /></a>
                  </dt>
                  <dd>
                    <a href=""
                      >ThinkPad E530c(33662D0) 15.6英寸笔记本电脑 （i5-3210M 4G
                      500G NV610M 1G独显 摄像头 Win8）</a
                    >
                  </dd>
        ...
        <div class="viewd leftbar mt10">
          ...
          <div class="leftbar_wrap">
            <dl>
              <dt>
                <a href=""><img src="/images/hpG4.jpg" alt="" /></a>
              </dt>
            ...
            <dl class="last">
              <dt>
                <a href=""><img src="/images/crazy4.jpg" alt="" /></a>
              </dt>
        ...
        <div class="summary">
          ...
          <div class="preview fl">
            ...
            <!--使用说明：此处的预览图效果有三种类型的图片，大图，中图，和小图，
					...
					其中大图分配到 a 标签的href属性，中图分配到 img 的src上。 下面的smallpic
					 则表示小图区域，格式固定，在 a 标签的 rel属性中，分别指定了中图（smallimage）
					 和大图（largeimage），img标签则显示小图，按此格式循环生成即可，
                ...
                <ul>
                  <li class="cur">
                    <a
                      ...
                      :rel="
                        '{gallery: \'gal1\', smallimage: \'' +
                        goodsInfo.logo.biglogo +
                        '\',largeimage: \'' +
                        goodsInfo.logo.xbiglogo +
                        '\'}'
                      "
                      ><img :src="goodsInfo.logo.biglogo"
                    /></a>
                  </li>
                  <li v-for="(v, k) in goodsInfo.photos" :key="k">
                    <a
                      href="javascript:void(0);"
                      :rel="
                        '{gallery: \'gal1\', smallimage: \'' +
          ...
          <div class="goodsinfo fl ml10">
            <ul>
              ...
              <li class="market_price">
                <span>定价：</span><em>￥6399.00</em>
              </li>
              <li class="shop_price">
                <span>本店价：</span> <strong>￥{{ goodsInfo.price }}</strong>
                <a href="">(降价通知)</a>
              </li>
              <li><span>上架时间：</span>{{ goodsInfo.on_sale_date }}</li>
              <li class="star">
                <span>商品评分：</span> <strong></strong
            ...
            <form action="" method="post" class="choose">
              <ul>
                <!--循环规格-->
                <li
                  v-for="(v, k) in goodsInfo.spec_list"
                  :key="k"
                  class="product"
                >
                  <dl>
                    ...
                    <dd>
                      <!--循环规格对应的选项-->
                      <a
                        @click="selecSpec(v.id, v1.id)"
                        v-for="(v1, k1) in v.options"
                        :key="k1"
                        :class="{
                          selected:
                            goodsInfo.spec_info.id_list.indexOf(
                              v.id + ':' + v1.id
                            ) != -1,
                        }"
                        href="javascript:;"
                        >{{ v1.option_name }}{{ v.id + ":" + v1.id }}</a
                      >
                    </dd>
                  </dl>
                </li>
        ...
        <div class="detail">
          ...
          <div class="detail_bd">
            ...
            <div class="comment detail_div mt10">
              <div class="comment_summary">
                ...
                <div class="percent fl">
                  <dl>
                    ...
                    <dd>
                      <div
                        :style="{ width: comments.ratio.goods + 'px' }"
                      ></div>
                    </dd>
                  </dl>
                  <dl>
                    ...
                    <dd>
                      <div
                        :style="{ width: comments.ratio.common + 'px' }"
                      ></div>
                    </dd>
                  </dl>
                  <dl>
                    ...
                    <dd>
                      <div :style="{ width: comments.ratio.bad + 'px' }"></div>
                    </dd>
                  </dl>
                </div>
                <div class="buyer fl">
                  <dl>
                    <dt>买家印象：</dt>
                    <dd v-for="(v, k) in comments.impressions" :key="k">
                      <span>{{ v.title }}</span
                      ><em>({{ v.count }})</em>
                    </dd>
                  </dl>
              ...
              <div
                v-for="(v, k) in comments.comment"
                :key="k"
                class="comment_items mt10"
              >
                <div class="user_pic">
                  <dl>
                    <dt>
                      <a href=""><img :src="v.user.face" alt="" /></a>
                    </dt>
                    <dd>
                ...
                <div class="item">
                  <div class="title">
                    ...
                    <strong :class="['star', 'star' + v.star]"></strong>
            ...
            <div class="after_sale mt15 none detail_div">
              ...
              <div>
                <h3>服务承诺：</h3>
                <p>
                  本商城向您保证所售商品均为正品行货，京东自营商品自带机打发票，与商品一起寄送。凭质保证书及京东商城发票，可享受全国联保服务（奢侈品、钟表除外；奢侈品、钟表由本商城联系保修，享受法定三包售后服务），与您亲临商场选购的商品享受相同的质量保证。本商城还为您提供具有竞争力的商品价格和运费政策，请您放心购买！
                </p>
...
export default {
  ...
  async mounted() {
    //1获取商品详情
    let { data } = await this.$axios.$get("/web-service/goods/" + this.skuid);
    this.goodsInfo = data.data;
    console.log(this.goodsInfo);
    //2获取商品评论
    let { data: comment_data } = await this.$axios.$get(
      "/web-service/comments/" + this.goodsInfo.spuid
    );
    this.comments = comment_data.data;
    console.log(this.comments);
  },
  methods: {
    //第一个参数：规格id，第二个参数选项id
    selecSpec(specId, optionId) {
      console.log(specId + ":" + optionId);
      console.log(this.goodsInfo.spec_info.id_list);
      //将新选中的sku的值，来替换老的sku的值
      let reg = new RegExp(specId + ":\\d+");
      //第一个参数，正则表达式
      //第二参数，新值
      //newid，替换完成之后的新的排列组合
      let newId = this.goodsInfo.spec_info.id_list.replace(
        reg,
        specId + ":" + optionId
      );
      //在skulist中找newId看是否能找到
      for (var i = 0; i < this.goodsInfo.sku_list.length; i++) {
        if (this.goodsInfo.sku_list[i].id_list == newId) {
          //重新在数据库中查找这个sku的信息
          this.$router.push("/goods/" + this.goodsInfo.sku_list[i].skuid);
          break;
        }
      }
    },
    ...
    async addToCart() {
      ...
      //判断用户是否登录
      if (this.token == null) {//未登录
        //存入localStorage中
        //存的时候可能localStorage中已经有购物车信息了，应先将其取出
        //如果存在购物车，则追加至购物车，
        //如果购物车信息为空，直接添加至购物车
        let cart = localStorage.getItem("cart");
        if (cart != null) {
          //本地存储中已有购物车信息
          //购物车不为空时，需要判断该商品是否已经在购物车中了
          //如果已在购物车中，改数量
          //如果不在，添加至购物车
          //定义一个变量，默认购物车中不存在改商品
          let isnew = true;
          cart = JSON.parse(cart); //将字符串cart转成对象
          for (let i = 0; i < cart.length; i++) {
            if (cart[i].skuid == this.skuid) {
	  ...
	  let  res=await this.$axios.$post("/cart-service/carts",goods)
	  if(res.data.errno==0){
		  //加入成功，直接跳转至购物车页面
	  }else{
		  //当errno==1时，失败，终止执行
  ...
  updated() {
    ...
    $("#backward").click(function () {
      ...
      if (offset <= 0) {
        $(".smallpic_wrap ul")
          .stop(true, false)
          .animate({ left: offset }, "slow", "", function () {
            //动画完成之后，判断是否到了左边缘
      ...
      if (offset >= -(len - 62 * 5)) {
        $(".smallpic_wrap ul")
          ...
          .animate({ left: offset }, "slow", "", function () {
            //判断是否到了右边缘
            if (
              parseInt($(".smallpic_wrap ul").css("left")) <= -(len - 62 * 5)
            ) {
